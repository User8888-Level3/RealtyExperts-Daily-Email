          ...
          <tr>
            <td style="padding: 40px;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin: 24px 0;">
                <tr>
                  <td align="center">
                    <img src="https://harvinder.dscloud.me/blog/wp-content/uploads/2026/02/re-daily-1-3.png" alt="Local Housing Statistics" width="100%" style="display: block; max-width: 100%; height: auto;">
                  </td>
                </tr>
              </table>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin: 24px 0;">
                <tr>
                  <td align="center">
                    <img src="https://harvinder.dscloud.me/blog/wp-content/uploads/2026/02/re-daily-2-3.png" alt="Market Analysis Chart" width="100%" style="display: block; max-width: 100%; height: auto;">
                  </td>
                </tr>
              </table>
...
const outputFile = `daily-market-glance-${data.date.replace(/\//g, '-')}.html`;
